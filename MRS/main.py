...
class MainWindow1(QWidget, From_Main):
    def __init__(self):
        super(MainWindow1, self).__init__()
        QWidget.__init__(self)
        self.setupUi(self)
        self.txt_display.setText("Output Window  ")
        self.BtnDescribe.clicked.connect(self.dataHead)
        self.all_data = pd.read_csv('./csvfiles/result.csv', usecols=['title', 'year', 'genres', 'overview', 'est'])
